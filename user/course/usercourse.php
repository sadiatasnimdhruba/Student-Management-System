...
if($conn)
{
  ...
  {
    $q = $_GET['q'];
    $sql="SELECT * fROM course where title LIKE '%$q%' or id='$q'";
  }
  else
  {
  ...
  <body style="background-image: linear-gradient(to right, rgba(255,0,0,0), rgb(2 67 147));">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link" aria-current="page" href="<?php echo $url; ?>user/userindex.php">Student</a>
        </li>

        <li class="nav-item">
          <a class="nav-link" href="<?php echo $url; ?>user/teacher/userteacher.php">Teacher</a>
        </li>
    ...
    <div class="container">
      <div class="row">
        ...
        <?php }?>
          ...
          <h2>Courses list</h2>
          <hr>
          <a class="btn btn-success mb-2" href="<?php echo $url; ?>teacher/userteacher.php">All courses  </a>
          ...
          <table class="table">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <a class="btn btn-info mb-2" href="userview.php?id=<?php echo $row['id'];?>">View  </a>
                </td>
