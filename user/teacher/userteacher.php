  ...
  <body style="background-image: linear-gradient(to right, rgba(255,0,0,0), rgb(2 67 147));">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link" href="<?php echo $url; ?>teacher/userteacher.php">Teacher</a>
        </li>
    ...
    <div class="container">
      <div class="row">
        ...
        <?php }?>
          ...
          <hr>
          <a class="btn btn-success mb-2" href="<?php echo $url; ?>teacher/userteacher.php">All faculties  </a>
