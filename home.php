...
<html lang="en">
                    ...
                    <div class="col-lg-10  ">
                        <h1 class="heading">Student Management System</h1>
                         ...
                         <p class="intro">A student management system is an automated version<br>of a manual student. This system can handle all the detail<br> about a student.</p>
                          ...
                          <br>
                          <br>
  	                     <a class="btn btn-success link" href="login&registration/login.php">Admin</a>
  	                     <a class="btn btn-success link" href="login&registration/userlogin.php">User</a>
    ...
    <div class="mb-5" id="about" style="margin-top:90px;">
        ...
        <h2>Our features </h2>
          ...
          <div class="col-md-3">
           ...
           <img src="images/student.jpg" width="100px";height="30px">
             ...
             <div class="col-md-3">
             	<div class="service-item">
           <img src="images/view.jpg" width="100px";height="30px">
             ...
             <div class="col-md-3">
             	<div class="service-item">
           <img src="images/edit.jpg" width="100px";height="30px">
             ...
             <div class="col-md-3">
             	<div class="service-item">
           <img src="images/delete.jpg" width="100px";height="30px">
  ...
  <footer class="py-5">
            <div class="container">
            	<<img  src="images/pic.jpg" width="120px" height="92px"><br>
