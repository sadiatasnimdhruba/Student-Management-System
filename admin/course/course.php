  ...
  <body style="background-image: linear-gradient(to right, rgba(255,0,0,0), rgb(2 67 147));">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link" aria-current="page" href="course.php">Courses</a>
        </li>
        <li class="nav-item">
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-3">
          <a class="btn btn-info mb-2" href="insert.php">New Course</a><br><br><br><br><br><br><br><br>
        ...
        <?php }?>
          ...
          <h2>Student list</h2>
          <hr>
          <a class="btn btn-success mb-2" href="index.php">All courses  </a>
